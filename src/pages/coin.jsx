                    ...
                    <section>
                        ...
                        <div className="content">
                            <div className="section">
                                ...
                                <p>
                                    Coin là điểm thưởng tích lũy có được khi học viên giới thiệu khóa
                                    học cho người mới hoặc tặng thưởng theo từng chương trình khác
                                    nhau.
                                </p>
                                <h3>
                                ...
                                <p>
                                    - Có tài khoản học viên mới đăng ký khoá học thành công thông qua
                                    link giới thiệu
                                </p>
                            ...
                            <div className="section">
                                ...
                                <p>
                                    ...
                                    nhận thành công từ đội ngũ Spacedev) tài khoản học viên giới thiệu
                                    sẽ được cộng một số điểm COIN tương ứng tùy từng khóa học (mỗi
                                    điểm có giá trị tương ứng 1000 đ).
                                </p>
                                <p>
                                    - Điểm COIN được cộng dồn khi có nhiều học viên mới đăng ký thành
                                    công qua đường dẫn giới thiệu.
                                </p>
                                <p>
                                ...
                                <p>
                                    - COIN có thể sử dụng để giảm giá cho những khoá học mới khi đăng
                                    ký khoá học tại website
                                ...
                                <p>
                                    ...
                                    thẻ cào điện thoại chỉ được áp dụng 2 lần đối với 1 tài khoản học
                                    viên).
                                </p>
                            </div>
                            <div className="section">
                                ...
                                <p>
                                    - Số tiền được giảm giá sẽ được hiển thị và được áp dụng khi đăng
                                    ký trực tuyến tại website của Spacedev qua link giới thiệu.
                                </p>
                            </div>
                        </div>
                    </section>
