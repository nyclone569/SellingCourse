                        ...
                        <div className="content">
                            <div className="section">
                                ...
                                <p>
                                    ...
                                    phí khi có sai sót trong quá trình chuyển khoản hoặc sai thông tin
                                    chuyển khoản. Nếu xảy ra sai sót, Bạn vui lòng làm việc với ngân
                                    hàng để được xử lí.
                                </p>
                                <p>
                                    <strong>THÔNG TIN TÀI KHOẢN:</strong> <br />
                                    <strong>Chủ tài khoản</strong>: TRUONG DANG NGHIA
                                    <br />
                                    <strong>Số tài khoản</strong>: 123456798123456
                                    <br />
                                    <strong>Ngân hàng</strong>: VCB - Tp Hồ Chí Minh
                                    <br />
                                    <strong>Nội dung chuyển khoản</strong>: Họ và tên số điện thoại mã
                                    khóa học (ví dụ: Nguyen Tuan Anh 0989998881 Spacedev2)
                                </p>
                                <p>
                                    <i>
                                ...
                                <p>
                                    ...
                                    khóa Spacedev OFFLINE. Thanh toán ngày đầu tiên khi tham gia khóa
                                    học.
                                </p>
                            </div>
                            <div className="section">
                                ...
                                <p>
                                    ...
                                    trặc do lỗi từ phía Spacedev gây ảnh hưởng nghiêm trọng đến quyền
                                    lợi của học viên.
                                </p>
                            </div>
                            <div className="section">
                                ...
                                <p>
                                    Sẽ được Spacedev thông báo công khai tại website theo từng chương
                                    trình ưu đãi cụ thể.
                                </p>
                            </div>
                        </div>
