            ...
            <div className="projectpage">
                <section className="section-1 ">
                    <div className="container">
                        ...
                        <p className="top-des">
                            Đây là những dự án do học viên hoàn thành trong các khóa học. Những dự
                            án hoàn toàn đạt tiêu chuẩn để làm trong các công ty công nghệ.
                        </p>
                        <div className="list row">
                            <a href="#" className="item col-md-6">
                                <div className="wrap">
                                    ...
                                    <div className="info">
                                        ...
                                        <div className="makeby">Hoàn thành với Đăng Nghĩa </div>
                                    </div>
                                </div>
                            </a>
                            <a href="#" className="item col-md-6">
                            ...
                            <a href="#" className="item col-md-6">
                                <div className="wrap">
                                    ...
                                    <div className="info">
                                        <div className="name">Shopper</div>
                                        <div className="makeby">Hoàn thành bởi Đăng Nghĩa</div>
                                    </div>
                                </div>
                            </a>
                            <a href="#" className="item col-md-6">
